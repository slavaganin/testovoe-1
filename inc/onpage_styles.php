...
function check_display_onpage_styles(){
  ...
  $understrap_builder_container_width = get_theme_mod( 'understrap_builder_container_width', '' );
  ...
  $us_b_fixed_top_padding_desktop = 90;
  $us_b_fixed_top_padding_tab_mob = 90;
  ...
  if($understrap_builder_submenu_type != 'none'){ $us_b_fixed_top_padding_desktop += 40; $us_b_fixed_top_padding_tab_mob += 40; }
  if($understrap_builder_navbar_position == 'top'){ $styles_to_display .= '#page{padding-top:'.$us_b_fixed_top_padding_desktop.'px}@media(max-width:992px){#page{padding-top:'.$us_b_fixed_top_padding_tab_mob.'px}}'; }
  ...
  // Typography
  $understrap_builder_typography_default_font = json_decode(get_theme_mod( 'understrap_builder_typography_default_font', '{"font":"Open Sans","regularweight":"regular","italicweight":"italic","boldweight":"700","category":"sans-serif"}' ));
  $understrap_builder_typography_heading_font_custom = get_theme_mod('understrap_builder_typography_heading_font_custom', 1);
  $understrap_builder_typography_heading_font = json_decode(get_theme_mod( 'understrap_builder_typography_heading_font', '{"font":"Open Sans","regularweight":"regular","italicweight":"italic","boldweight":"700","category":"sans-serif"}' ));
  ...
  $understrap_builder_typography_font_size = get_theme_mod( 'understrap_builder_typography_font_size', '' );
  ...
  $understrap_builder_typography_heading_font_default = get_theme_mod( 'understrap_builder_typography_heading_font_default', 0 );
  if($understrap_builder_typography_heading_font_default == 1){
    foreach($us_b_heading_sizes as $heading_size => $heading_settings){
      ...
      $understrap_builder_heading_size = get_theme_mod( 'understrap_builder_typography_heading_font_'.$heading_size_lower, $heading_settings['default'] );
  ...
  $understrap_builder_typography_default_line_height = get_theme_mod( 'understrap_builder_typography_default_line_height', '1.5' );
  $understrap_builder_typography_default_heading_line_height = get_theme_mod( 'understrap_builder_typography_default_heading_line_height', '1.2' );
  $understrap_builder_typography_default_p_margin_bottom = get_theme_mod( 'understrap_builder_typography_default_p_margin_bottom', '1rem' );
  ...
  // Links
  $understrap_builder_links_color = get_theme_mod( 'understrap_builder_links_color', '#7c008c' );
  $understrap_builder_links_decoration = get_theme_mod( 'understrap_builder_links_decoration', 'none' );
  $understrap_builder_links_rollover_color = get_theme_mod( 'understrap_builder_links_rollover_color', '#380040' );
  $understrap_builder_links_rollover_weight = get_theme_mod( 'understrap_builder_links_rollover_weight', 'normal' );
  $understrap_builder_links_rollover_decoration = get_theme_mod( 'understrap_builder_links_rollover_decoration', 'underline' );
  ...
  // Buttons
  $understrap_builder_buttons_curved_borders = get_theme_mod( 'understrap_builder_buttons_curved_borders', '0.25rem' );
  $understrap_builder_buttons_shadow = get_theme_mod( 'understrap_builder_buttons_shadow', 'none' );
  $understrap_builder_buttons_rollover = get_theme_mod( 'understrap_builder_buttons_rollover', 'none' );
  ...
  if($understrap_builder_hero_layout != 'disabled'){
    ...
    $understrap_builder_hero_vertical_margin = get_theme_mod( 'understrap_builder_hero_vertical_margin', 100);
    $understrap_builder_hero_vertical_margin_mobile = get_theme_mod( 'understrap_builder_hero_vertical_margin_mobile', 50);
    $understrap_builder_hero_bg_img = get_theme_mod( 'understrap_builder_hero_bg_img', '');
    ...
    if($understrap_builder_hero_bg_img != ''){
      $understrap_builder_hero_bg_img_fixed = get_theme_mod( 'understrap_builder_hero_bg_img_fixed', 'default');
      ...
      if($understrap_builder_navbar_position != 'default'){ $styles_to_display .= "#us_b_navbar_hero_wrap{margin-top:-90px}"; }
    }
  }
  
  // Animated burger
  $understrap_builder_mobile_hamburger_style = get_theme_mod( 'understrap_builder_mobile_hamburger_style', '');
  ...
  // Footer
  $understrap_builder_footer_bg_img = get_theme_mod( 'understrap_builder_footer_bg_img', '' );
  if($understrap_builder_footer_bg_img != ''){
    $understrap_builder_footer_bg_img_fixed = get_theme_mod( 'understrap_builder_footer_bg_img_fixed', 'default');
