...
if ( ! class_exists( 'BUILDER_Options' ) ) {
	...
	class BUILDER_Options {
      ...
      if($_GET['page'] == 'understrap-builder-settings' && $_GET['us_b_delete_all'] == '1'){
        understrap_builder_reset_default();
      }
      
      // Force check for new theme version
      $checking_for_latest_version = false;
      if($_GET['page'] == 'understrap-builder-settings' && $_GET['us_b_force_version_check'] == '1'){
      ...
      <style>
        ...
        <div class="main-content row">
          ...
          <div id="us_b_options_side" class="col col-2">
            ...
            <a href="https://builder.understrap.com/d/pro/" target="_blank" class="button button-primary">Go PRO Now</a>
