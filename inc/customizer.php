...
if ( ! function_exists( 'understrap_builder_customize_register' ) ) {
  ...
  function understrap_builder_customize_register( $wp_customize ) {
    ...
    // On screen jQuery setting
		$wp_customize->add_setting(
			...
			array(
				'default'           => '',
				'type'              => 'theme_mod',
				'sanitize_callback' => 'understrap_builder_html_sanitize',
				'capability'        => 'edit_theme_options',
			)
		);
    ...
    // Theme layout navbar background color when hero present
    $wp_customize->add_control(
			new WP_Customize_Control(
				$wp_customize,
				'understrap_builder_navbar_bg_hero',
				array(
					'label'       => __( 'Navbar/Submenu Background [Hero Active]', 'understrap-builder' ),
					'description' => __( 'Choose to show the menu & submenu background when you have activated the hero on the home page.', 'understrap-builder' ),
					'section'     => 'understrap_builder_navbar_options',
					'settings'    => 'understrap_builder_navbar_bg_hero',
					'type'        => 'select',
					'choices'     => array(
						'show'            => __( 'Show Background Over Hero', 'understrap-builder' ),
            'transparent'     => __( 'Transparent Background Over Hero', 'understrap-builder' )
					),
					'priority'    => '18',
				)
			)
    ...
    $wp_customize->add_control(
			new Skyrocket_Text_Radio_Button_Custom_Control(
				...
				array(
					...
					'choices'     => array(
						'thin'         => __( 'Thin Links', 'understrap-builder' ),
            'medium'       => __( 'Medium Links', 'understrap-builder' ),
            'wide'         => __( 'Wide Links', 'understrap-builder' ),
    ...
    $wp_customize->add_control(
			new Skyrocket_Text_Radio_Button_Custom_Control(
				...
				array(
					...
					'description' => __( 'Use default built in Bootstrap colors on site. (refresh after changes to update live color choices in other sections)', 'understrap-builder' ),
...
function understrap_builder_customize_style() {
  ...
  <style>
    ...
    #customize-control-understrap_builder_sidebars_single_width, #customize-control-understrap_builder_submenu_type, #customize-control-understrap_builder_navbar_search_show, 
    ...
    #customize-control-understrap_builder_breadcrumbs_home_page, #customize-control-understrap_builder_typography_heading_font_custom {
      padding-top: 10px;
      margin-top: 10px;
      border-top: 1px solid #ddd;
    }
    #accordion-section-understrap_builder_navbar_options, #accordion-section-custom_css {
      margin-top: 16px;
    }
    ...
    #accordion-section-understrap_builder_spacings_single_section h3, #accordion-section-understrap_builder_spacings_page_section h3{
