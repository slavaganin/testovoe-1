...
if($understrap_builder_navbar_cta_fa_icon != ''){
  if($understrap_builder_navbar_cta_fa_icon_side == 'left'){
    $understrap_builder_navbar_cta_fa_icon_string = '<i class="mr-1 fa fa-'.esc_attr($understrap_builder_navbar_cta_fa_icon).'"></i>';
  } else {
    $understrap_builder_navbar_cta_fa_icon_string = '<i class="ml-1 fa fa-'.esc_attr($understrap_builder_navbar_cta_fa_icon).'"></i>';
  }
}
            ...
            <?php if($understrap_builder_navbar_cta_show != 0){ ?>
              <a href="<?php echo esc_attr($understrap_builder_navbar_cta_url); ?>" 
                ...
                <?php if($understrap_builder_navbar_cta_fa_icon_side == 'left'){ ?>
                  <?php echo esc_attr($understrap_builder_navbar_cta_fa_icon_string); ?> 
                <?php } ?>
